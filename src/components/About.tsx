      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 items-center">
          <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight mb-4 reveal">
              IT Engineer & Frontend Developer
              <span className="block opacity-70 text-xl sm:text-2xl mt-1">with a passion for user experience</span>
            </h2>
            ...
            <div className="space-y-3 sm:space-y-4 reveal">
              <h3 className="text-lg sm:text-xl font-medium">Technical Skills</h3>
          ...
          <div className="order-1 lg:order-2 reveal">
            <div className={cn(
              ...
              />
              <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 p-4 sm:p-6 glass rounded-lg z-20 reveal stagger-2">
